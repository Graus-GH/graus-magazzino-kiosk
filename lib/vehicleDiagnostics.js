...
const DIAGNOSTIC_MATCHERS = {
  fuelLevel: n => n.includes("fuel level"),
  odometer: n => n.includes("odometer") && !n.includes("adjustment"),
  fuelEconomy: n => n.includes("average fuel economy") || (n.includes("fuel economy") && !n.includes("instantaneous"))
};
